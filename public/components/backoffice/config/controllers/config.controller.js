angular
    .module('MainApp')
    .controller('ConfigCtrl', function($scope, ConfigService, $modal) {
        ConfigService.findAll().success(function(config){
            ...
            var modalInstance = $modal.open({
                ...
                controller: function ($scope, $modalInstance) {
                    ...
                    $scope.save = function () {
                        ...
                        ConfigService.set(_.extend(getParentScope().parameters,config)).success(function(){
            ...
            var modalInstance = $modal.open({
                ...
                controller: function ($scope, $modalInstance) {
                    $scope.save = function () {
                        ...
                        ConfigService.set(getParentScope().parameters).success(function(){
                            $modalInstance.dismiss('cancel');
                        })
                    };
        ...
        $scope.monitor = {
            set : function(){
                ConfigService.monitor.start($scope.app).success(function(data){
                    $scope.app.isMonitored = true;
                })
            },
            stop : function(){
                ConfigService.monitor.stop().success(function(data){
                    $scope.app.isMonitored = false;
                })
            }
        }

        ConfigService.monitor.state().success(function(data){
        ...
        $scope.shell  = function(operation){
            ...
            ConfigService.shell(operation).success(function(response, code){
